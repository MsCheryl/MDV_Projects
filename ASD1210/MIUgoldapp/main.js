    ...
    $( '#couchJsonInfo' ).on( 'click', function () {
        ...
        $.ajax( {
            ...
            success:function ( data ) {
                //console.log(data);
                $.each( data.rows, function( index, members ){
                    console.log(members);
                    
                    var greetings = members.value.greetings;
                    var fullName = members.value.fullName;
                    var spousName = members.value.spouseName;
                    var gender = members.value.gender
                    $('#membersList").append(
                    	$('<li>').append(
                    		$('<a>').attr("href","#").text(fullName)
                    	)		
                    );
                });
